<template>
  <f7-page>
    <f7-block-title>Administrateur</f7-block-title>

    <f7-block-title></f7-block-title>
      <f7-list class="components-list searchbar-found">

      <f7-list-item link="/admin-search-mobility/" title="Rechercher une mobilité" panel-close>
        <f7-icon slot="media" ios="f7:info" md="material:info"></f7-icon>
      </f7-list-item>

      <f7-list-item link="/admin-map/" title="Carte des mobilités" panel-close>
        <f7-icon slot="media" ios="f7:map_pin" md="material:map_pin"></f7-icon>
      </f7-list-item>
